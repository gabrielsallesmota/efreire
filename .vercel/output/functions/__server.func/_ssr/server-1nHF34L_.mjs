...
import { C as rootRouteId, D as invariant, S as isResolvedRedirect, a as RouterProvider, b as executeRewriteInput, t as renderRouterToStream, w as isNotFound, x as isRedirect, y as resolveManifestAssetLink } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D6RJzUoE.mjs");
