// Insights / Perspectivas — Efreire
// Conteúdo editorial inspirado em McKinsey Insights, Bain Brief, BCG Publications.
...
export type Insight = {
  ...
  category: string;
  title: string;
  dek: string; // subtítulo / resumo curto
  readTime: string; // "6 min de leitura"
...
export const INSIGHTS: Insight[] = [
  {
    ...
    sections: [
      {
        heading: "Por que a previsibilidade é o ativo mais subestimado da gestão financeira",
        paragraphs: [
        ...
        subsections: [
          {
            heading: "O custo invisível do caixa reativo",
            paragraphs: [
      ...
      {
        heading: "Os três blocos de uma estrutura de caixa previsível",
        paragraphs: [
        ...
        subsections: [
          {
            heading: "1. Fonte única da verdade",
            paragraphs: [
          ...
          {
            heading: "2. Rotinas de fechamento curtas",
            paragraphs: [
          ...
          {
            heading: "3. Indicadores de leading, não apenas lagging",
            paragraphs: [
      ...
      {
        heading: "Como uma jornada de 90 dias normalmente se desenrola",
        paragraphs: [
    ...
    takeaway:
      "Previsibilidade não é resultado de mais planilhas — é consequência de processos curtos, fonte única de dados e indicadores que antecipam o futuro. Empresas que estruturam esses três blocos liberam capacidade de decisão e reduzem o custo do capital próprio.",
  },
  {
    slug: "dre-gerencial-que-decide",
    category: "Controladoria",
    title: "DRE gerencial: do relatório contábil ao instrumento de decisão",
    dek: "A maior parte das PMEs olha para um DRE que explica o passado. O DRE gerencial, quando bem desenhado, explica o que fazer amanhã.",
    ...
    sections: [
      {
        heading: "O que diferencia um DRE gerencial bem construído",
        paragraphs: [
        ...
        subsections: [
          {
            heading: "Margem por linha, não apenas no total",
            paragraphs: [
          ...
          {
            heading: "Despesa por natureza e por destino",
            paragraphs: [
      ...
      {
        heading: "Os erros mais comuns que esvaziam o DRE gerencial",
        paragraphs: [
          "Três erros recorrentes transformam o relatório em peça decorativa.",
        ],
        subsections: [
          {
            heading: "Rateio que esconde a realidade",
            paragraphs: [
          ...
          {
            heading: "Frequência baixa demais",
            paragraphs: [
    ...
    takeaway:
      "O DRE gerencial não é versão estendida do contábil — é instrumento desenhado para decisão. Quando expõe margem por dimensão, classifica despesa por destino e vem acompanhado de leitura, vira o documento mais importante da reunião mensal da diretoria.",
  },
  {
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          {
            heading: "Reporte regular ao colegiado",
            paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "A experiência em grupos como Via Varejo mostra que os princípios viajam bem, mas os instrumentos precisam ser redesenhados para PMEs.",
        ],
        subsections: [
          {
            heading: "Adaptar: políticas e alçadas",
            paragraphs: [
          ...
          {
            heading: "Não copiar: estruturas com sobreposição de comitês",
            paragraphs: [
      ...
      {
        heading: "Quando começar — e por onde",
        paragraphs: [
    ...
    takeaway:
      "Governança financeira em PME não é miniatura da governança de grupo — é instrumento próprio, leve e proporcional. Os princípios são universais (segregação, trilha e reporte), mas as ferramentas precisam ser desenhadas para a realidade da empresa em crescimento.",
  },
];
