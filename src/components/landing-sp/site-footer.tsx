  ...
  return (
    <footer className="bg-ink-dark px-[5%] pb-8 pt-13 text-white/45">
      <div className="flex flex-wrap items-start justify-between gap-10 border-b border-white/10 pb-8">
        <div>
          <img src="/efreire-assessoria-e-servicos-especializados-logo-landing-sp.png" alt="Efreire Assessoria & Estratégia Financeira" className="mb-4 h-10" />
          <p className="max-w-[300px] text-[13px] leading-[1.7]">
            Efreire Assessoria & Estratégia Financeira Ltda. Transformamos gestão
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-6 text-xs">
        <span className="text-white/30">
          © {new Date().getFullYear()} Efreire Assessoria & Estratégia Financeira Ltda.
        </span>
